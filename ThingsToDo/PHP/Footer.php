...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/Reserva360/ThingsToDo/CSS/Footer.css" />
...
<body>
  ...
  <div class="col-2">
    ...
    <form action="">
      ...
      <br><button type="submit"> SUBSCRIBE NOW </button>
    </form>
  </div>
  <div class="icons">
    <p>Join With US on </p>
