...
<head>
    ...
    <link rel="stylesheet" href="../CSS/displayDeals.css">
    <title>Deals</title>
</head>
    ...
    <table>
        ...
        if ($resultCheck > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo " 
                    <tr>
                        <td class='firstRow'> " . $row['hotelName'] . " </td> 
                        <td> " . $row['image'] . " </td>                       
                        <td> " . $row['location'] . " </td>
                        <td> " . $row['deal'] . " </td>
                        <td class='middleRow'> " . $row['description'] . " </td>
                        <td>                        
                            <button class='addDeals'> <a href='http://localhost/Reserva360/AdminAccount/PHP/addNewDeal.php'>Add a Deal</a></button>                         
                            <button class='update' > <a href='http://localhost/Reserva360/AdminAccount/phpHandlers/dbh.updateDeals.php?updateDealId= " . $ID . "'>Modify</a> </button> 
                            <button class='delete' > <a href='http://localhost/Reserva360/AdminAccount/phpHandlers/dbh.deleteDeals.php?deleteDealId= " . $ID . "'>Delete</a> </button> 
                        </td>                        
                    </tr>";
            }
        }
